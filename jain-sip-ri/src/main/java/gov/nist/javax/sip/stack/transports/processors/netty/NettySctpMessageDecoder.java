...
/**
 * Netty Based SCTP Message Decoder to handle Incoming SIP Messages
 * 
 * @author Jean Deruelle
 */
public class NettySctpMessageDecoder extends SctpMessageToMessageDecoder {
    ...
    public NettySctpMessageDecoder(SIPTransactionStack sipStack) {    
