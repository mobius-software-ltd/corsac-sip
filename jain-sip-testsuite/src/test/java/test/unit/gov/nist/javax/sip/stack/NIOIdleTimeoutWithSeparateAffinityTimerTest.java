...
import gov.nist.javax.sip.stack.timers.SeparateAffinitityExecutorSipTimer;
...
public class NIOIdleTimeoutWithSeparateAffinityTimerTest  extends ScenarioHarness {


    public NIOIdleTimeoutWithSeparateAffinityTimerTest() {
    	super("NIOIdleTimeoutWithSeparateAffinityTimerTest",true);
	}
