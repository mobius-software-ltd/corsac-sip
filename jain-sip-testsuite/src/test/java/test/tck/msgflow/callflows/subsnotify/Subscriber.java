...
public class Subscriber implements SipListener {
    ...
    private HashSet<Dialog> dialogs;
    ...
    static {
        try {
            ...
            configuration.addAppender(FileAppender.newBuilder().setName("Subscriberoutputlog").withFileName("target/logs/subscriberoutputlog.txt").build());
