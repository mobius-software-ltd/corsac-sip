...
import gov.nist.javax.sip.stack.transports.processors.oio.UDPMessageProcessor;
    ...
    public MessageProcessor createMessageProcessor(
            ...
            if (transport.equalsIgnoreCase(ListeningPoint.UDP)) {
            	...
            	if("true".equals(((SipStackImpl)sipStack).getConfigurationProperties().getProperty("gov.nist.javax.sip.USE_TLS_GATEWAY"))) {
            		NioTlsWebSocketMessageProcessor mp = new NioTlsWebSocketMessageProcessor(
                            ipAddress, sipStack, port);
            		return mp;
            	} else {
            		NioWebSocketMessageProcessor mp = new NioWebSocketMessageProcessor(
                            ipAddress, sipStack, port);
            		return mp;
            	}
