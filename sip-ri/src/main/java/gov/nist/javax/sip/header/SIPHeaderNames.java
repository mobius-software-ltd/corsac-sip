...
public interface SIPHeaderNames {
	...
	public static final String ACCEPT_RESOURCE_PRIORITY = AcceptResourcePriorityHeader.NAME; //55
	public static final String RESOURCE_PRIORITY = ResourcePriorityHeader.NAME; //56
