...
/**
 * SIP Resource-Priority header implementation.
 */
public class ResourcePriority extends ParametersHeader implements ExtensionHeader, ResourcePriorityHeader {
    ...
    public static final String NAME = "Resource-Priority"; // Ensure the correct header name
     ...
     */
    public ResourcePriority(String namespace, String priority) throws IllegalArgumentException {
        super(NAME); // Ensure the superclass is properly initialized
    ...
    public void decodeBody(String body) throws ParseException {
        try {
            ...
            String[] resourcePriority = parts[0].split("\\.");

            if (resourcePriority.length != 2) {
                throw new ParseException("Invalid Resource-Priority header format", 0);
            }

            this.namespace = resourcePriority[0].trim();
            this.priority = resourcePriority[1].trim();
            ...
            throw new ParseException("Error parsing Resource-Priority header: " + e.getMessage(), 0);
        }
    }
