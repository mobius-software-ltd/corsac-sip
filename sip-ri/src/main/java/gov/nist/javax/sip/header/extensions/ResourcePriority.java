 ...
 */
public class ResourcePriority extends SIPHeader implements ExtensionHeader, ResourcePriorityHeader {
     ...
     */
    public ResourcePriority(List<Resource> resources) throws IllegalArgumentException {
        super(NAME); // Ensure the superclass is properly initialized
