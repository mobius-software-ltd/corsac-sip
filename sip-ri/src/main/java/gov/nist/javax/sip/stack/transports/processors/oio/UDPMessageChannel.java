...
package gov.nist.javax.sip.stack.transports.processors.oio;
...
import gov.nist.javax.sip.stack.transports.processors.nio.DatagramQueuedMessageDispatch;
...
public class UDPMessageChannel extends MessageChannel implements
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (sipStack.getThreadPoolSize() != -1) {
     ...
     */
    public void sendMessage(byte[] msg, InetAddress peerAddress,
    ...
    protected void sendMessage(byte[] msg, InetAddress peerAddress,
        ...
        if (peerProtocol.compareToIgnoreCase("UDP") == 0) {
            ...
            TCPMessageProcessor tcpMessageProcessor = (TCPMessageProcessor) 
                sipStack.findMessageProcessor(this.messageProcessor.getIpAddress().getHostAddress(), peerPort, peerProtocol);
            // Use TCP to talk back to the sender.
            Socket outputSocket = tcpMessageProcessor.getIOHandler().sendBytes(
